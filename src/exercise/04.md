...
* `React.createElement(,)` gets as first argument - an element as string (div, span, etc), a string ('bla') or a function that returns element (will be rendered as a component);
* second argument is for props.
* Childen can be specified in one of 3 ways:
  * `React.createElement('div', {children:'hellow world'})`
  * `React.createElement('div', {children:['hellow world', 'goodbye world']})`
  * `React.createElement('div', {}, 'hellow world', 'goodbye world')`
